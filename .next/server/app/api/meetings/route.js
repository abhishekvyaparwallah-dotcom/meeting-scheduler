"use strict";(()=>{var e={};e.id=643,e.ids=[643],e.modules={11185:e=>{e.exports=require("mongoose")},72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},67691:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>E,patchFetch:()=>A,requestAsyncStorage:()=>T,routeModule:()=>S,serverHooks:()=>I,staticGenerationAsyncStorage:()=>v});var o={};a.r(o),a.d(o,{GET:()=>h,POST:()=>b});var i=a(49303),n=a(88716),s=a(60670),r=a(87070),l=a(15143),d=a(2021),p=a(87545),c=a(47014),m=a(71732),u=a(82941),g=a(41905),f=a(81401),y=a(25502),x=a(80156);async function h(){let e=await (0,l.I8)();if(!e?.user)return r.NextResponse.json({message:"Unauthorized"},{status:401});let t=e.user.role,a=e.user.employeeId;try{await (0,d.v)();let e=(await p.Z.find("ADMIN"===t?{}:{assignedEmployeeId:a}).sort({date:1,time:1}).lean()).map(e=>({id:e._id.toString(),date:e.date,time:e.time,clientName:e.clientName,clientType:e.clientType,phone:e.phone,businessAddress:e.businessAddress||"",mapsLink:e.mapsLink||"",assignedEmployeeId:e.assignedEmployeeId,createdByEmployeeId:e.createdByEmployeeId,leadId:e.leadId,notes:e.notes||"",status:e.status||"scheduled",convertedToClient:e.convertedToClient||!1,dealAmount:e.dealAmount,contractDuration:e.contractDuration,acquisitionExpense:e.acquisitionExpense,nextFollowUp:e.nextFollowUp,createdAt:e.createdAt?.toISOString?.()||new Date().toISOString(),updatedAt:e.updatedAt?.toISOString?.()||new Date().toISOString()}));return r.NextResponse.json({meetings:e})}catch(o){console.warn("[API MEETINGS] Fallback to in-memory store:",o.message);let e="ADMIN"===t?x.l.meetings:x.l.meetings.filter(e=>e.assignedEmployeeId===a);return r.NextResponse.json({meetings:e})}}async function b(e){let t;let a=await (0,l.I8)();if(!a?.user)return r.NextResponse.json({message:"Unauthorized"},{status:401});let o=a.user.role,i=a.user.employeeId,n=await e.json();if(!n.date||!n.time||!n.clientName||!n.phone)return r.NextResponse.json({message:"Missing required fields: Date, Time, Client Name, and Phone Number."},{status:400});await (0,d.v)();let s="ADMIN"===o?n.assignedEmployeeId??i:i;try{await (0,d.v)();let e=(await p.Z.find({status:{$ne:"cancelled"}}).lean()).map(e=>({id:e._id.toString(),date:e.date,time:e.time,clientName:e.clientName,clientType:e.clientType,phone:e.phone,assignedEmployeeId:e.assignedEmployeeId,status:e.status,convertedToClient:e.convertedToClient,createdAt:e.createdAt?.toISOString?.()||"",updatedAt:e.updatedAt?.toISOString?.()||""})),o=(0,f.Sn)(e,n.date,n.time);if(!o.valid)return r.NextResponse.json({message:o.message},{status:400});let l=await p.Z.create({date:n.date,time:n.time,clientName:n.clientName,clientType:n.clientType??"Clinic / Hospital",phone:n.phone,businessAddress:n.businessAddress??"",mapsLink:n.mapsLink??"",assignedEmployeeId:s,createdByEmployeeId:i,leadId:n.leadId,notes:n.notes??"",status:n.status??"scheduled",convertedToClient:n.convertedToClient??!1,dealAmount:n.dealAmount,contractDuration:n.contractDuration,acquisitionExpense:n.acquisitionExpense,nextFollowUp:n.nextFollowUp});if(t={id:l._id.toString(),date:l.date,time:l.time,clientName:l.clientName,clientType:l.clientType,phone:l.phone,businessAddress:l.businessAddress||"",mapsLink:l.mapsLink||"",assignedEmployeeId:l.assignedEmployeeId,createdByEmployeeId:l.createdByEmployeeId,leadId:l.leadId,notes:l.notes||"",status:l.status,convertedToClient:l.convertedToClient,dealAmount:l.dealAmount,contractDuration:l.contractDuration,acquisitionExpense:l.acquisitionExpense,nextFollowUp:l.nextFollowUp,createdAt:l.createdAt.toISOString(),updatedAt:l.updatedAt.toISOString()},n.leadId)try{await c.Z.findByIdAndUpdate(n.leadId,{status:"MEETING_BOOKED",updatedAt:new Date})}catch(e){console.error("Failed to update linked lead status:",e)}try{await u.Z.create({employeeId:i,employeeName:a.user.name??"Staff",actionType:"CREATE_MEETING",entityType:"meeting",entityId:t.id,details:`Booked meeting with ${t.clientName} (${t.clientType}) on ${t.date} at ${(0,f.s8)(t.time)}`})}catch(e){console.error("Failed to save audit log:",e)}}catch(a){console.warn("[API MEETINGS POST] DB error, using fallback in-memory store:",a.message);let e=(0,f.Sn)(x.l.meetings,n.date,n.time);if(!e.valid)return r.NextResponse.json({message:e.message},{status:400});if(t={id:`MEET-${Date.now()}`,date:n.date,time:n.time,clientName:n.clientName,clientType:n.clientType??"Clinic / Hospital",phone:n.phone,businessAddress:n.businessAddress||"",mapsLink:n.mapsLink||"",assignedEmployeeId:s,createdByEmployeeId:i,leadId:n.leadId,notes:n.notes||"",status:n.status??"scheduled",convertedToClient:n.convertedToClient??!1,dealAmount:n.dealAmount,contractDuration:n.contractDuration,acquisitionExpense:n.acquisitionExpense,nextFollowUp:n.nextFollowUp,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()},x.l.meetings.unshift(t),n.leadId){let e=x.l.leads.find(e=>e.id===n.leadId);e&&(e.status="MEETING_BOOKED",e.updatedAt=new Date().toISOString())}}let h=await m.Z.findOne({employeeId:s}),b=[t.phone,h?.phone].filter(Boolean),S=(0,f.s8)(t.time);return await (0,g.zC)({numbers:b,clientName:t.clientName,date:t.date,time:S,repName:"Abhishek Kumar",notes:t.notes}),await (0,g.Mx)({numbers:b,message:`Vyapar Wallah: Meeting confirmed with ${t.clientName} on ${t.date} at ${S}.${t.mapsLink?` Maps: ${t.mapsLink}`:""}`,route:"q"}),await (0,y.B)({meeting:t,bookedByName:a.user.name??"Staff",bookedByRole:o}),r.NextResponse.json({meeting:t},{status:201})}let S=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/meetings/route",pathname:"/api/meetings",filename:"route",bundlePath:"app/api/meetings/route"},resolvedPagePath:"C:\\Users\\avina\\OneDrive\\Desktop\\Meeting schduler\\app\\api\\meetings\\route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:T,staticGenerationAsyncStorage:v,serverHooks:I}=S,E="/api/meetings/route";function A(){return(0,s.patchFetch)({serverHooks:I,staticGenerationAsyncStorage:v})}},25502:(e,t,a)=>{a.d(t,{B:()=>s,N:()=>r});var o=a(55245),i=a(81401);function n(){let e=process.env.SMTP_HOST,t=Number(process.env.SMTP_PORT)||587,a=process.env.SMTP_USER,i=process.env.SMTP_PASS,n="true"===process.env.SMTP_SECURE||465===t;return e&&a&&i?o.createTransport({host:e,port:t,secure:n,auth:{user:a,pass:i}}):null}async function s({meeting:e,bookedByName:t,bookedByRole:a}){let o=process.env.ADMIN_NOTIFICATION_EMAIL||"admin@vyaparwallah.com",s=process.env.EMAIL_FROM||'"Vyapar Wallah Alert" <no-reply@vyaparwallah.com>',r=(0,i.s8)(e.time),l=`🚀 New Meeting Fixed: ${e.clientName} (${e.clientType}) - ${e.date} at ${r}`,d=`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  `,p=n();if(!p)return console.log("\n================== [ADMIN EMAIL NOTIFICATION] =================="),console.log(`To: ${o}`),console.log(`Subject: ${l}`),console.log(`Client: ${e.clientName} (${e.clientType})`),console.log(`Date & Time: ${e.date} at ${r}`),console.log(`Phone: ${e.phone}`),console.log(`Booked By: ${t} (${a})`),console.log("----------------------------------------------------------------"),console.log("NOTE: To send live emails, configure SMTP_HOST, SMTP_USER, and SMTP_PASS in .env.local."),console.log("================================================================\n"),{success:!0,message:"Email preview generated in server console (SMTP credentials not configured)."};try{let e=await p.sendMail({from:s,to:o,subject:l,html:d});return console.log(`[EMAIL SENT] Notification delivered to Admin (${o}): Message ID ${e.messageId}`),{success:!0,message:`Email notification sent successfully to ${o}`}}catch(e){return console.error("[EMAIL ERROR] Failed to send email via SMTP:",e),{success:!1,message:e?.message||"Failed to send email via SMTP."}}}async function r({email:e,name:t,otp:a,role:o}){let i=process.env.EMAIL_FROM||'"Vyapar Wallah Security" <no-reply@vyaparwallah.com>',s=`🔐 [Security Code: ${a}] Login Verification - Vyapar Wallah`,r=`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  <div class="card">
    ...
    <div class="content">
      <div class="greeting">Hello, ${t} (${o}) 👋</div>
